...
const USER_API_BASE_URL = 'http://localhost:5101/api/users'; // Base URL for user-related APIs
const BOOKING_API_BASE_URL = 'http://localhost:5101/api/bookings'; // Base URL for booking-related APIs
